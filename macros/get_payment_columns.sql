...
{% set columns = [
    ...
    {"name": "process_payment", "alias": "process_payment", "quote": true, "datatype": "boolean"},
    {"name": "receivable_account_id", "alias": "receivable_account_id", "quote": true, "datatype": dbt_utils.type_int()},
    {"name": "reference_number", "alias": "reference_number", "quote": true, "datatype": dbt_utils.type_string()},
    ...
    {"name": "unapplied_amount", "alias": "unapplied_amount", "quote": true, "datatype": dbt_utils.type_float()},
