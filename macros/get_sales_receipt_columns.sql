...
{% set columns = [
    ...
    {"name": "delivery_time", "alias": "delivery_time", "quote": true, "datatype": "date"},
    ...
    {"name": "email_status", "alias": "email_status", "quote": true, "datatype": dbt_utils.type_string()},
    ...
    {"name": "ship_date", "alias": "ship_date", "quote": true, "datatype": "date"},
