...
{% set columns = [
    ...
    {"name": "paymentrefnum", "alias": "payment_reference_number", "quote": true, "datatype": dbt_utils.type_string()},
    ...
    {"name": "trackingnumber", "alias": "tracking_number", "quote": true, "datatype": dbt_utils.type_string()},
