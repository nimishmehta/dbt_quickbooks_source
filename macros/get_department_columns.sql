...
{% set columns = [
    ...
    {"name": "parent_department_id", "alias": "parent_department_id", "quote": true, "datatype": dbt_utils.type_int()},
    {"name": "subdepartment", "alias": "sub_department", "quote": true, "datatype": "boolean"},
