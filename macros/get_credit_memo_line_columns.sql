...
{% set columns = [
    ...
    {"name": "description_service_date", "alias": "description_service_date", "quote": true, "datatype": dbt_utils.type_timestamp()},
    ...
    {"name": "sales_item_service_date", "alias": "sales_item_service_date", "quote": true, "datatype": dbt_utils.type_timestamp()},
